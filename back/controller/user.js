...
const Client = require("../model/user").Client;
...
exports.signup = async (req, res) => {
  ...
  // const isEmailExsistForCompany = await Company.findOne({
  //   email: req.body.email,
  // });
  // if (isEmailExsistForCompany)
  //   return res
  //     .status(400)
  //     .send("email already exist in Company ,You can't registered");
  ...
  try {
    ...
    const token = jwt.sign({ _id: client._id }, URL);
