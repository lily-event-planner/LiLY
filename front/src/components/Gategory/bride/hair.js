...
class Hair extends Component {
  ...
  render() {
    ...
    //   }}
    // >
    //   {/* <h2 className="card__title"> {this.props.data[3].name}</h2> */}
    //   <img
    //     className="card__img"
    ...
    //   }}
    // >
    //   <h2 className="card__title"> {this.props.data[2].name} </h2>
    //   <img
    //     className="card__img"
    ...
    //   }}
    // >
    //   <h2 className="card__title">  {this.props.data[5].name} </h2>
    //   <img
    //     className="card__img"
